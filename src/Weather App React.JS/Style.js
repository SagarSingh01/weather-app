...
const Style = {
  ...
  searchWrapperClass: "flex items-center w-full max-w-md mx-auto bg-[#020617]/80 rounded-full px-4 py-3 border border-cyan-400/30 focus-within:border-cyan-300 focus-within:shadow-[0_0_15px_rgba(0,255,255,0.6)] transition-all duration-300",

  searchInputClass: "flex-1 bg-transparent text-cyan-100 placeholder-gray-400 outline-none text-lg",

  searchIconClass: "text-cyan-400 cursor-pointer transition-all duration-300 hover:scale-125 hover:text-white hover:drop-shadow-[0_0_10px_cyan]",
